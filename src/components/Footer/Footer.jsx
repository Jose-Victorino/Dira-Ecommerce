      ...
      <section className={cn('container flex-wrap gap-40', s.main)}>
        <div className={cn('flex-col a-center gap-20', s.left)}>
          ...
          <ul className={s.socmed}>
            <li>
              <Link to='https://www.facebook.com/JoseVictorinoo' onClick={() => scrollReset()} target='_blank'>
                {facebookSVG}
              </Link>
            </li>
            <li>
              <Link to='https://github.com/Jose-Victorino' onClick={() => scrollReset()} target='_blank'>
                {githubSVG}
              </Link>
            </li>
            <li>
              <Link to='https://www.linkedin.com/in/jose-victorino/' onClick={() => scrollReset()} target='_blank'>
                {linkedinSVG}
              </Link>
            </li>
          </ul>
        ...
        <div className='flex-col gap-30'>
          ...
          <ul className={cn('flex-col gap-10', s.navLink)}>
            ...
            <li>
              <Link to='/shop' onClick={() => scrollReset()}>
                Shop
              </Link>
            </li>
            <li>
              <Link to='/faq' onClick={() => scrollReset()}>
                FAQ
              </Link>
            </li>
            <li>
